...
getNameByPersonalNr(){
  // this.arbeitszeitService.getNameByPersonalNr(this.arbeitszeit)

  if (this.arbeitszeit.personalNr === 6389){
    this.arbeitszeit.vorname = "Marcel"
    this.arbeitszeit.nachname = "Maier"
    this.erfolgreich = true;
  } else if (this.arbeitszeit.personalNr === 595){
    this.arbeitszeit.vorname = "Mouafak"
    this.arbeitszeit.nachname = "Al Bunni"
    this.erfolgreich = true;
  } else {
